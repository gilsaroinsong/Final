                        ...
                        apiData.map((el, idx) => {
                                if(keyword.length > 0) {
                                    return <b.Row key={idx}>
                                        {el.name.toLowerCase().includes(keyword.toLowerCase()) ? <b.Col><Card title={el.name} subtitle={el.country} text="" link="Rincian" img="" idx={idx}/></b.Col> : null}
                                    </b.Row>
                                } else {
                                    return <b.Row key={idx}>
                                        <b.Col><Card title={el.name} subtitle={el.country} text="" link="Rincian" img="" idx={idx}/></b.Col>
                                    </b.Row>
                                }
                            }
                        )
